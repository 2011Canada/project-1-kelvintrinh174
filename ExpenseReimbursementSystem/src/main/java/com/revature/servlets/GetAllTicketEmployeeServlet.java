...
/**
 * Servlet implementation class GetAllTicketEmployee
 */
@WebServlet("/getallticketemployee")
public class GetAllTicketEmployeeServlet extends HttpServlet {
     ...
     */
    public GetAllTicketEmployeeServlet() {
        super();
    }
    ...
    protected void directControlRouter(HttpServletRequest req, HttpServletResponse res)
    	    throws ServletException,IOException
    	    {
    			switch (req.getMethod()) {
    					case "GET":{
    						reimbursementController.getAllTicketEmployee(req, res);
    						break;
    					}
    					default:{
    						res.setStatus(400);
    						res.getWriter().write("Method Not Supported for /GetAllTicketEmployee");
    						break;
    					}
