...
/**
 * Servlet implementation class GetATicketById
 */
@WebServlet("/getticketbyid")
public class GetATicketByIdServlet extends HttpServlet {
    ...
    protected void directControlRouter(HttpServletRequest req, HttpServletResponse res)
    	    throws ServletException,IOException
    	    {
    			switch (req.getMethod()) {
    					case "GET":{
    						reimbursementController.getTicketById(req, res);
    						break;
    					}
    					default:{
    						res.setStatus(400);
    						res.getWriter().write("Method Not Supported for /getticketbyid");
    						break;
    					}
